...
Form::Form()
    : name_("default"), gradeToSign_(LOWEST_GRADE), gradeToExec_(LOWEST_GRADE),
      beSigned_(false) {}
...
Form::Form(const Form &f)
    : name_(f.name_), gradeToSign_(f.gradeToSign_),
      gradeToExec_(f.gradeToExec_), beSigned_(f.beSigned_) {
  *this = f;
}
...
const char *Form::NoSignException::what() const throw() { return "Not signed"; }

bool Form::getBeSigned() const { return beSigned_; }
